...
SCAM_OPTIONS_BY_LANG: dict[str, list[dict]] = {
    "hi": [
        {"id": "digital_arrest", "title": "डिजिटल अरेस्ट", "description": "वीडियो कॉल पर अरेस्ट की धमकी"},
        {"id": "fake_police", "title": "नकली पुलिस/CBI", "description": "पुलिस/CBI बनके कॉल किया"},
        {"id": "fake_rbi", "title": "नकली RBI/बैंक", "description": "अकाउंट फ्रीज़ की धमकी"},
        {"id": "kyc_expiry", "title": "KYC/आधार", "description": "KYC एक्सपायर, आधार ब्लॉक"},
        {"id": "otp_demand", "title": "OTP/पैसा माँगा", "description": "OTP या पैसा ट्रांसफर माँगा"},
        {"id": "customs_parcel", "title": "कस्टम्स/पार्सल", "description": "पार्सल में ड्रग्स, फाइन भरो"},
        {"id": "lottery_prize", "title": "लॉटरी/प्राइज़", "description": "प्राइज़ जीता, फीस भरो"},
        {"id": "job_offer", "title": "नकली जॉब", "description": "पहले इन्वेस्ट करो फिर कमाओ"},
        {"id": "loan_offer", "title": "लोन स्कैम", "description": "लोन के लिए चार्जेस भरो"},
        {"id": "other", "title": "कुछ और", "description": "ऊपर में से कोई नहीं"},
    ],
    "en": [
    ...
    "te": [
        {"id": "digital_arrest", "title": "డిజిటల్ అరెస్ట్", "description": "వీడియో కాల్ లో అరెస్ట్ బెదిరింపు"},
        {"id": "fake_police", "title": "నకిలీ పోలీసు/CBI", "description": "పోలీసు/CBI గా కాల్ చేశారు"},
        {"id": "fake_rbi", "title": "నకిలీ RBI/బ్యాంక్", "description": "అకౌంట్ ఫ్రీజ్ చేస్తామని"},
        {"id": "kyc_expiry", "title": "KYC/ఆధార్", "description": "KYC ఎక్స్‌పైర్, ఆధార్ బ్లాక్"},
        {"id": "otp_demand", "title": "OTP/డబ్బు అడిగారు", "description": "OTP లేదా డబ్బు ట్రాన్స్‌ఫర్ అడిగారు"},
        {"id": "customs_parcel", "title": "కస్టమ్స్/పార్సెల్", "description": "పార్సెల్ లో డ్రగ్స్, ఫైన్ కట్టండి"},
        {"id": "lottery_prize", "title": "లాటరీ/ప్రైజ్", "description": "ప్రైజ్ గెలిచారు, ఫీ కట్టండి"},
        {"id": "job_offer", "title": "నకిలీ జాబ్", "description": "ముందు ఇన్వెస్ట్ చేయండి"},
        {"id": "loan_offer", "title": "లోన్ స్కామ్", "description": "లోన్ కోసం చార్జెస్ కట్టండి"},
        {"id": "other", "title": "వేరేది", "description": "పైన ఏవీ కాదు"},
    ],
}
...
def get_scam_type_question(language: str) -> str:
    ...
    numbered = "\n".join(f"{i}\ufe0f\u20e3 {opt['title']}" for i, opt in enumerate(options, start=1))
    return f"{intro}\n\n{numbered}"
